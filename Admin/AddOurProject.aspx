<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddOurProject.aspx.cs" Inherits="Admin_AddOurProject" %>
                        ...
                        <div class="col-sm-12 col-lg-12 col-xs-12">                            
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="">
                                    Project Name
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddContact" ControlToValidate="txtname" ID="RequiredFieldValidator3" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="">
                                    Project Description
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddContact" ControlToValidate="txtshortdes" ID="RequiredFieldValidator9" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                    </asp:RequiredFieldValidator>
                                </label>
                                <div>
                                    <asp:TextBox runat="server" ID="txtshortdes" ValidationGroup="AddContact" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 table-responsive">
                            <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table table-striped table-bordered" AutoGenerateColumns="false">
                               <Columns>
                                   <asp:BoundField DataField="Category" HeaderText="Project Category" />
