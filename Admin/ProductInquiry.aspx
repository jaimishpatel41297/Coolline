<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ProductInquiry.aspx.cs" Inherits="Admin_ProductInquiry" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12 col-xs-12">                            
                            ...
                            <div class="form-group">
                                <label for="">
                                    Content
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddContact" ControlToValidate="txtcon" ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                    </asp:RequiredFieldValidator>
                                </label>
                                <div>
                                    <asp:TextBox runat="server" ID="txtcon" ValidationGroup="AddContact" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 table-responsive">
                            <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table table-striped table-bordered" AutoGenerateColumns="false">
                               <Columns>
                                    <asp:BoundField  DataField="Series" HeaderText="Product Name"/>
