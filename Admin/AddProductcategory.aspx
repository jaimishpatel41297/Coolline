<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddProductcategory.aspx.cs" Inherits="Admin_AddProductcategory" %>
                        ...
                        <div class="col-sm-12 col-lg-12 col-xs-12">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div>
                                    <asp:TextBox runat="server" ID="txtdes" TextMode="MultiLine" ValidationGroup="AddContact" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                              <div class="form-group">
                                 <label for="">
