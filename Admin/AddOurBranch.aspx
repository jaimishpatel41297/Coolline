<%@ Page Language="C#"  MasterPageFile="~/Admin/AdminMaster.master"  AutoEventWireup="true" CodeFile="AddOurBranch.aspx.cs" Inherits="Admin_AddOurBranch" %>
 ...
 <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Our Branch </h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12 col-xs-12">                            
                            ...
                            <div class="form-group">
                                <label for="">
                                    Branch Address
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddContact" ControlToValidate="txtdadd" ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                    </asp:RequiredFieldValidator>
                                </label>
                                <div>
                                    <asp:TextBox runat="server" ID="txtdadd" ValidationGroup="AddContact" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                               ...
                               <div class="form-group">
                                <label for="">
                                   Email
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddContact" ControlToValidate="txtemail" ID="RequiredFieldValidator3" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                    </asp:RequiredFieldValidator>
                                </label>
                                <div>
                               ...
                               <div class="form-group">
                                <label for="">
                                   ContactNo
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddContact" ControlToValidate="txtcon" ID="RequiredFieldValidator4" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                    </asp:RequiredFieldValidator>
                                </label>
                                <div>
                               ...
                               <div class="form-group">
                                <label for="">
                                    FaxNumber
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddContact" ControlToValidate="txtfax" ID="RequiredFieldValidator5" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                    </asp:RequiredFieldValidator>
                                </label>
                                <div>
                                    <asp:TextBox runat="server" ID="txtfax" ValidationGroup="AddContact"  CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-xs-12 table-responsive">
                            <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table table-striped table-bordered" AutoGenerateColumns="false">
                               <Columns>
                                    ...
                                    <asp:BoundField  DataField="FaxNumber" HeaderText="Branch FaxNumber"/>
