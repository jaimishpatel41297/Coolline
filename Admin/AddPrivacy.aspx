<%@ Page Language="C#"  MasterPageFile="~/Admin/AdminMaster.master"  AutoEventWireup="true" CodeFile="AddPrivacy.aspx.cs" Inherits="Admin_AddPrivacy" %>
 ...
 <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Privacy & Declaration </h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12 col-xs-12">                            
                            <div class="form-group">
                                <label for="">
                                    Privacy
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddContact" ControlToValidate="txtpvcy" ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                    </asp:RequiredFieldValidator>
                                </label>
                                <div>
                                    <asp:TextBox runat="server" TextMode="MultiLine" ID="txtpvcy" ValidationGroup="AddContact" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <asp:TextBox runat="server" TextMode="MultiLine" ID="txtdes"  ValidationGroup="AddContact"  CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table table-striped table-bordered" AutoGenerateColumns="false">
                               <Columns>
                                   <asp:BoundField  DataField="Privacy" HeaderText="Privacy "/>
                                    <asp:BoundField  DataField="Disclaimer" HeaderText="Disclaimer"/>
