<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master"   AutoEventWireup="true" CodeFile="AddFaq.aspx.cs" Inherits="Admin_AddFaq" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12 col-xs-12">                            
                            <div class="form-group">
                                <label for="">
                                    FAQ Title
                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="AddContact" ControlToValidate="txttlt" ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*
                                    </asp:RequiredFieldValidator>
                                </label>
                                <div>
                                    <asp:TextBox runat="server" ID="txttlt" ValidationGroup="AddContact" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <asp:TextBox runat="server" ID="txtdes" ValidationGroup="AddContact" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 table-responsive">
                            <asp:GridView runat="server" ID="gv" CssClass="gvDataTable table table-striped table-bordered" AutoGenerateColumns="false">
                               <Columns>
                                   <asp:BoundField  DataField="Title" HeaderText="Faq Title"/>
