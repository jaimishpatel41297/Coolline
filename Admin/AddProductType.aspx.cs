...
public partial class Admin_AddProductType : System.Web.UI.Page
{
    ...
    protected void lbSubmit_Click(object sender, EventArgs e)
    {
        ...
        qry = "insert into ProductType (Name) values('" + txtname.Text + "')";
    ...
    protected void lbUpdate_Click(object sender, EventArgs e)
    {
        ...
        qry = "Update ProductType set Name='" + txtname.Text + "' where ID=" + lbSubmit.CommandArgument;
    ...
    protected void lbEdit_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = D.GetData("select * from ProductType where ID=" + lb.CommandArgument);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void lbDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            D.ExecuteQuery("delete from ProductType where ID=" + id);
            divSuccess.Visible = true;
            divError.Visible = false;
            BindData();
            Clear();
