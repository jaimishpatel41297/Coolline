...
public partial class Admin_AddOurClient : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        try
        {
            DataTable dt = D.GetDataTable("select * from OurClient");
            if (dt.Rows.Count > 0)
            {
                gv.DataSource = dt;
                gv.DataBind();
    ...
    protected void lbSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (file.HasFile)
        {
            ...
            qry = "insert into OurClient (Name,Photo) values('" + txtname.Text + "','" + img + "')";
            cmd.Connection = cn;
            cmd.CommandText = qry;
            cn.Open();
            cmd.ExecuteNonQuery();
    ...
    protected void lbUpdate_Click(object sender, EventArgs e)
    {
       SqlCommand cmd = new SqlCommand();
        ...
        if (file.HasFile)
        {
            ...
            qry = "Update OurClient set Name='" + txtname.Text + "',Photo='" + img + "' where Id=" + lbSubmit.CommandArgument;
           
        }
        else
        {

            qry = "Update OurClient set Name='" + txtname.Text + "' where Id=" + lbSubmit.CommandArgument;
    ...
    protected void lbEdit_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = D.GetData("select * from OurClient where ID=" + lb.CommandArgument);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void lbDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            D.ExecuteQuery("delete from OurClient where ID=" + id);
            divSuccess.Visible = true;
            divError.Visible = false;
            BindData();
            Clear();
